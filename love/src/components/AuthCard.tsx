...
import { Mail, Lock, Phone, UserCheck } from "lucide-react";
...
const AuthCard = () => {
  ...
  const handleAuth = () => {
    // Basic validation
    if (!email || !password || !phone || (!isLogin && !name)) {
          ...
          <CardHeader className="text-center">
            ...
            <CardDescription>
              {isLogin
                ...
                : "Create your account to start filing taxes"}
            </CardDescription>
          </CardHeader>
